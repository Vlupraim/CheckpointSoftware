...
namespace CheckpointSoftware.masterDataSetTableAdapters {
...
SELECT Id, Sku, Nombre, Unidad, VidaUtilDias, TempMin, TempMax, StockMinimo, Activo FROM Producto WHERE (Id = @Id)";
        ...
        public virtual int Fill(masterDataSet.ProductoDataTable dataTable) {
        ...
        public virtual masterDataSet.ProductoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet.ProductoDataTable dataTable = new masterDataSet.ProductoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet.ProductoDataTable dataTable) {
